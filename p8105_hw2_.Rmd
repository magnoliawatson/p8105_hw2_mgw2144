...
The dataset "mci_combine" created by merging only the data on participants in both the "mci_baseline" and "mci_amyloid" datasets has `r nrow(mci_combine)` particpants included. 
