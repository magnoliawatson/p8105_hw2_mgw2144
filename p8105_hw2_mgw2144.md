...
columns with a total of 487 participants. I used the pivot_long function
to change the time column names into variables in a new “time” column
with their corresponding amyloid values for each unique patient ID
number.
