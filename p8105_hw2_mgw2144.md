...
throug the inner_join() function. The combined dataset has 471 rows and
8 columns. The prominent variables in this dataset are patient id
(“id”), age at baseline “current_age”, sex, education level
(“education”), whether or not they are an APoE4 gene carrier, age at
onset of MCI, time in years from baseline when amyliod values were
tested “time”, and amyloid value at those time intervals.
